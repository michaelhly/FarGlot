...
class HubEvent(_message.Message):
    __slots__ = ["type", "id", "merge_message_body", "prune_message_body", "revoke_message_body", "merge_id_registry_event_body", "merge_name_registry_event_body", "merge_username_proof_body", "merge_on_chain_event_body"]
