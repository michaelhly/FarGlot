...
class ContactInfoContent(_message.Message):
    __slots__ = ["gossip_address", "rpc_address", "excluded_hashes", "count", "hub_version", "network", "app_version"]
...
class GossipMessage(_message.Message):
    __slots__ = ["message", "id_registry_event", "contact_info_content", "network_latency_message", "topics", "peer_id", "version"]
    ...
    def __init__(self, message: _Optional[_Union[_message_pb2.Message, _Mapping]] = ..., id_registry_event: _Optional[_Union[_id_registry_event_pb2.IdRegistryEvent, _Mapping]] = ..., contact_info_content: _Optional[_Union[ContactInfoContent, _Mapping]] = ..., network_latency_message: _Optional[_Union[NetworkLatencyMessage, _Mapping]] = ..., topics: _Optional[_Iterable[str]] = ..., peer_id: _Optional[bytes] = ..., version: _Optional[_Union[GossipVersion, str]] = ...) -> None: ...
