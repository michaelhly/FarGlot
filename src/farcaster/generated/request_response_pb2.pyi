...
class SyncStatus(_message.Message):
    __slots__ = ["peerId", "inSync", "shouldSync", "divergencePrefix", "divergenceSecondsAgo", "theirMessages", "ourMessages", "lastBadSync"]
    PEERID_FIELD_NUMBER: _ClassVar[int]
...
class OnChainEventRequest(_message.Message):
    ...
    def __init__(self, fid: _Optional[int] = ..., event_type: _Optional[_Union[_onchain_event_pb2.OnChainEventType, str]] = ...) -> None: ...
...
class OnChainEventResponse(_message.Message):
    ...
    def __init__(self, events: _Optional[_Iterable[_Union[_onchain_event_pb2.OnChainEvent, _Mapping]]] = ...) -> None: ...
